...
function js_scripts()
{
    ...
    wp_register_script('mi-js', get_bloginfo('template_directory') . '/assets/librerias/js/mis-scrits.js', array('jquery'), '1', true); //footer
...
add_action("wp_enqueue_scripts", "js_scripts", 1);
